...
const SeatPage = () => {
  ...
  return (
    <div className="page-container">
      ...
      {selectedShowtime && (
        <div className="gap-x-5 font-bold text-lg text-white bg-black rounded-md">
          <div className="bg-ticket-dot bg-repeat-x overflow-hidden w-full h-[8px] rotate-180"></div>
          <div className="flex">
...
const PaymentPopup = ({
  ...
  const confirmPayment = () => {
    axios
      ...
      .then((response) => {
        alert("Vé đã được gửi thành công!", response.data);
