...
const SeatPage = () => {
  ...
  return (
    <div className="page-container">
      ...
      {selectedShowtime && (
        <div className="gap-x-5 font-bold text-lg text-white bg-black rounded-md px-5 py-3">
          <div className="bg-ticket-dot bg-repeat-x overflow-hidden w-full h-[8px]"></div>
          <div className="flex">
