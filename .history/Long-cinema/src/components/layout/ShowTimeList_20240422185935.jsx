...
const ShowTimeList = ({ item, handleClosePopupClick }) => {
  ...
  return (
    <div>
      <div className="block popup w-full h-full text-black fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-white p-8 border border-gray-300 shadow-lg z-50">
        <div className="popup-content max-h-80vh overflow-y-auto">
          <span className="close absolute top-2 right-2 cursor-pointer">
            &times;
          </span>
