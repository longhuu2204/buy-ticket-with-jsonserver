...
const ShowTimeList = ({ item, handleClosePopupClick }) => {
  ...
  return (
    <div>
      <div className="block popup text-black fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-white p-8 border border-gray-300 shadow-lg z-50">
