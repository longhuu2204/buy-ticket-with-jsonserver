...
const BuyTicketButton = () => {
  ...
  const HandleBuyTicketClick = () => {
    setIsPopupOpen(true);
    setSelectedMovieId(id); // Lưu id của phim được chọn
    const showtimeListApi = `http://localhost:3000/showtime?movie=${selectedMovieId}`;
  ...
  const handleClosePopupClick = () => {
    ...
    setSelectedMovieId(null); // Reset id của phim được chọn
  };
  return (
    <div>
