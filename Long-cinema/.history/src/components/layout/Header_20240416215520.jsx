...
const Header = () => {
  return (
    <header>
      <div className="nav flex justify-end gap-x-5 max-w-5xl mx-auto py-2">
        <NavLink
          to="/"
      ...
      <div className="logo-and-nav bg-header-bg-img w-[100vw] mb-5">
        <div className="flex items-center h-[120px] max-w-5xl mx-auto">
          <a className="logo">
            <img
          ...
          <div className="flex translate-y-4 gap-x-5 font-bold hover:text-primary">
